...
validating security assurances. The “Zero Trust” approach is described in the [Security Design Principles](/azure/architecture-center/doc/security/security-principles) section in more detail.
