...
validating security assurances. The “Zero Trust” approach is described in the [Security Design Principles](/architecture-center/docs/security/security-principles) section in more detail.
